...
| 버전        | v1.2.2                                                                                                                                                    |
| 갱신        | 2026-08-12                                                                                                                                                |
| 작성자      | product-designer (opus)                                                                                                                                   |
| 변경        | v1.2.2 코드 정합 재감사 + 도메인 규칙 신설. globals.css 840줄 전 토큰(색·간격·모서리·그림자·컨테이너·겹침) 재대조 → 전부 일치 확인. **등급 스케일 = 1~9 도메인 규칙 신설**(수능·모의 9등급 상대평가). exam-hall-card 게이지가 1~5로 그려진 것을 오류로 지정하고 게이지 규격 §6.3.1로 박음. 갭 상세는 `docs/mvp-g/design-system-parity-2026-08-12.md`. |
