...
export const Controlled: Story = { render: () => <SelectControlledDemo /> };

function SelectWithFormDemo() {
  const formSchema = z.object({
    student: z.string().min(1, '학생을 선택해주세요.'),
  });

  const form = useForm<{ student: string }>({
...
export const WithForm: Story = { render: () => <SelectWithFormDemo /> };
