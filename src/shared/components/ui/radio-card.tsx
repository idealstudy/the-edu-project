 ...
 * - 스타일 상태는 Radix mock-attribute 로 제어됨
 *    - mock-[state=checked] : 선택됨
 *    - mock-[disabled]      : 비활성화
 *
 * 주의사함
...
// 따라서 스타일 레벨에서 mock-[disabled]:cursor-not-allowed 적용 검토
  ...
  return (
    <Label.Root
      className={cn(
        ...
        'mock-[state=checked]:border-key-color-primary mock-[state=checked]:shadow',
        'mock-[disabled]:cursor-not-allowed mock-[disabled]:opacity-50',
