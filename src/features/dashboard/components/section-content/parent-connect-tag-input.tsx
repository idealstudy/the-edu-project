    ...
    <div className="w-full">
      ...
      >
        <PopoverAnchor asChild>
          <div
            className={cn(
              'border-line-line1 rounded-control-compact flex min-h-14 w-full cursor-text items-center border bg-white px-5 transition-colors',
              open
          ...
          >
            {selectedMember ? (
              <div className="bg-background-gray border-line-line1 flex max-w-full items-center gap-2 rounded-sm border py-2 pr-2 pl-3 text-sm">
                <span className="max-w-30 truncate text-base text-black">
                  {selectedMember.name}
                </span>
                <span className="text-key-color-primary">•</span>
                <span className="text-key-color-primary max-w-65 truncate">
        ...
        >
          {isFetching ? (
            ...
            <div className="max-h-54 overflow-y-auto py-2">
