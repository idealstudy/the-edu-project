...
export const TeacherDashboardHeader = ({
  ...
  return (
    <header className="border-gray-3 sticky top-0 z-30 flex items-center gap-3 border-b bg-white px-4 py-3 md:px-[22px]">
      ...
      <div className="ml-auto flex gap-5 text-right">
        <div>
          <small className="text-gray-8 block text-[10px] font-bold">
            손볼 것 · 누르면 정렬
          </small>
        ...
        <div className="hidden sm:block">
          ...
          <b className="block text-sm font-extrabold tabular-nums">
            0분{' '}
            <em className="text-gray-8 text-[11px] font-bold not-italic">
              / 30분
            </em>
          </b>
        </div>
