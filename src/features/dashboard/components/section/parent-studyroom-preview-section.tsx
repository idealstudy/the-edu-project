...
interface StudyRoomPreviewSectionProps {
  studyRoomPreviewData: ParentDashboardStudyRoomPreviewListDTO;
...
export const StudyRoomPreviewSection = ({
  ...
  if (studyRoomPreviewDataLength === 0) {
    content = (
  ...
  } else if (studyRoomPreviewIsPending) {
    content = (
  ...
  return (
    <section>
      <DashboardSection
        ...
        count={studyRoomPreviewDataLength}
