...
export const StudyNoteDetailContentsSection = ({
  ...
  return (
    <ColumnLayout.Right className="border-line-line1 desktop:max-w-185 max-h-[calc(100vh-var(--spacing-header-height)-48px)] overflow-y-auto rounded-xl border bg-white px-8 py-10">
