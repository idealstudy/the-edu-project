    ...
    <div className="w-full">
      ...
      >
        <PopoverTrigger asChild>
          <div
            className={cn(
              'border-gray-scale-gray-50 text-gray-scale-gray-40 flex min-h-14 cursor-text flex-wrap items-center gap-2 rounded-sm border px-6 py-3.75',
              ...
              <>
                ...
                {selected.map((student) => {
                  ...
                  return (
                    <div
                      key={student.id}
                      className="bg-background-gray border-line-line1 flex items-center gap-1 rounded-sm py-2 pl-3 text-sm"
                    >
        ...
        >
          ...
          {filtered.length === 0 ? (
            ...
            <div className="mt-4 flex max-h-37.5 flex-wrap gap-2 overflow-y-auto">
