import { StudyNoteQueryKey } from '@/features/study-notes/services/query-options';
import { StudyRoomsGroupQueryKey } from '@/features/study-rooms/services/query-options';
